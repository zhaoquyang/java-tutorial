...
![img](https://gitee.com/quyangzhao/images/tree/dev/snap/20181127203324.png)

SDK 路径是否正确

![img](https://gitee.com/quyangzhao/images/tree/dev/snap/20181127203427.png)

- **查看 Settings > Maven 的配置**

JDK for importer 是否正确

![img](https://gitee.com/quyangzhao/images/tree/dev/snap/20181127203408.png)

Runner 是否正确

![img](https://gitee.com/quyangzhao/images/tree/dev/snap/20181127203439.png)
