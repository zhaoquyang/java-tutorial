...
![img](https://gitee.com/quyangzhao/images/tree/dev/snap/20181106143734.png)
...
![img](https://gitee.com/quyangzhao/images/tree/dev/snap/20181127203029.png)
...
![img](https://gitee.com/quyangzhao/images/tree/dev/snap/20181127203131.png)

点击右上角 Sign in 登录，默认用户名/密码为：admin/admin123。

有必要提一下的是，在 Nexus 的 Repositories 管理页面，展示了可用的 maven 仓库，如下图所示：

![img](https://gitee.com/quyangzhao/images/tree/dev/snap/20181127203156.png)
